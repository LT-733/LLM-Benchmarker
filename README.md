...
## So how do I use it?
The first thing to know is that this is an LLM benchmarker. So it will use LLMs. If you hate AI slop you are free to leave at this point, because later, there will be screenshots with a lot of LLM stuff.
